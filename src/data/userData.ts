...
export class UserData {
  ...
  saveUser(user: any) {
    return db.one('INSERT INTO odonto.user (email, nome, id_empresa, senha, access_levels, status) VALUES ($1, $2, $3, $4, $5, $6) returning *',
      [user.email, user.nome, user.id_empresa, user.senha, user.access_levels, true])
  }
}
